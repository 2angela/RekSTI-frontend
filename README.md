...
3. Buka ```localhost:3000``` pada web browser atau jalankan https://dorm-remote-monitoring.vercel.app/
...
|Menerima peringatan pelanggaran|Yes|Yes|
|Menerima notifikasi|Yes|No|
